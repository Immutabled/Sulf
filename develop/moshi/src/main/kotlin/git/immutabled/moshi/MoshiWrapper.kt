...
val PolymorphicJsonAdapterFactory<*>.labels: List<String>
    get() = ReflectionUtil.getDeclaredField(this,"labels") as List<String>

val PolymorphicJsonAdapterFactory<*>.subTypes: List<Type>
    get() = ReflectionUtil.getDeclaredField(this,"subtypes") as List<Type>

val PolymorphicJsonAdapterFactory<*>.baseType: Class<*>
    get() = ReflectionUtil.getDeclaredField(this,"baseType") as Class<*>