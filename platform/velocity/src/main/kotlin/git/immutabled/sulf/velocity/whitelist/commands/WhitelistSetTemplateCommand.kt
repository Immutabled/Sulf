 ...
 */
class WhitelistSetTemplateCommand(
    ...
    override fun execute(invocation: SimpleCommand.Invocation) {
        ...
        if (args.isEmpty()) {
            ...
            source.sendMessage(Component.text("Usage: /whitelist template <template>", NamedTextColor.RED))
            return
        }
        ...
        plugin.server.eventManager.fireAndForget(
            StaffAlertEvent(
                Component.text()
                    ...
                    .append(Component.text("Whitelist template set to ", NamedTextColor.GREEN))
