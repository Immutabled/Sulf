...
class TemplateDeleteCommand(
    ...
    override fun execute(invocation: SimpleCommand.Invocation) {
        ...
        if (args.isEmpty()) {
            source.sendMessage(Component.text("Usage: /template delete <name>", NamedTextColor.RED))
            return
        }
        ...
        plugin.server.eventManager.fireAndForget(
            StaffAlertEvent(
                Component.text()
                    ...
                    .append(Component.text("Template '", NamedTextColor.RED))
                    .append(Component.text(templateName, NamedTextColor.WHITE))
                    .append(Component.text("' deleted by ", NamedTextColor.RED))
